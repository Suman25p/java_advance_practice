...
public class SellerOnboardingController {
	...
	@ResponseBody
	public String doOnboarding(@ModelAttribute OnboardingRequest request, @PathVariable("id") String id)
	{
		...
		return "Seller ID " + id + " We have received the onboarding request! Our team will get in touch with you for next step!";
